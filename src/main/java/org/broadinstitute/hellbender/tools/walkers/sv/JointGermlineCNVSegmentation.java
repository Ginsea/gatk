...
public class JointGermlineCNVSegmentation extends MultiVariantWalkerGroupedOnStart {
    ...
    private class CopyNumberAndEndRecord {
     ...
     */
    @VisibleForTesting
    protected List<VariantContext> resolveVariantContexts(final List<VariantContext> overlappingVCs) {
     ...
     */
    @VisibleForTesting
    protected VariantContext updateGenotypes(final VariantContext vc, final Map<String, CopyNumberAndEndRecord> sampleCopyNumbers) {
    ...
    private VariantContext buildVariantContext(final SVCallRecordWithEvidence call, final ReferenceSequenceFile reference) {
        Utils.nonNull(call);
